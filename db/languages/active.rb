...
[
  ...
  # },
  {
    ...
    is_archived: false,
    source_file: "main.c",
    compile_cmd: "/usr/local/gcc-13.2.0/bin/gcc %s main.c",
    run_cmd: "./a.out"
  },
  # {
  #   id: 50,
  ...
  {
    id: 59,
    name: "Fortran (GFortran 13.2.0)",
    is_archived: false,
    source_file: "main.f90",
    compile_cmd: "/usr/local/gcc-13.2.0/bin/gfortran %s main.f90",
    run_cmd: "LD_LIBRARY_PATH=/usr/local/gcc-13.2.0/lib64 ./a.out"
  },
  {
    id: 60,
    ...
    is_archived: false,
    source_file: "main.go",
    compile_cmd: "GOCACHE=/tmp/.cache/go-build /usr/local/go-1.22.0/bin/go build %s main.go",
    run_cmd: "./main"
  },
  # {
  #   id: 61,
  ...
  {
    id: 63,
    name: "JavaScript (Node.js 20.11.1)",
    is_archived: false,
    source_file: "script.js",
    run_cmd: "/usr/local/node-20.11.1/bin/node script.js"
  },
  # {
  #   id: 64,
  #   name: "Lua (5.3.5)",
  ...
  # },
  {
    ...
    run_cmd: "/usr/local/php-8.3.3/bin/php script.php"
  },
  # {
  #   id: 69,
  ...
  # },
  {
    ...
    run_cmd: "/usr/local/python-3.13.0/bin/python2 script.py"
  },
  # {
  #   id: 71,
  #   name: "Python (3.8.1)",
  ...
  # },
  {
    ...
    run_cmd: "/usr/local/ruby-3.3.0/bin/ruby script.rb"
  },
  {
    id: 73,
    name: "Rust (1.76.0)",
    is_archived: false,
    source_file: "main.rs",
    compile_cmd: "/usr/local/rust-1.76.0/bin/rustc %s main.rs",
    run_cmd: "./main"
  },
  {
    id: 74,
  ...
  # },
  {
    ...
    is_archived: false,
    source_file: "Main.kt",
    compile_cmd: "/usr/local/kotlin-1.9.22/bin/kotlinc %s Main.kt",
    run_cmd: "/usr/local/kotlin-1.9.22/bin/kotlin MainKt"
  },
  # {
  #   id: 79,
  ...
  # },
  {
    ...
    run_cmd: "/usr/local/r-4.3.2/bin/Rscript script.r"
  },
  # {
  #   id: 81,
  #   name: "Scala (2.13.2)",
  ...
  # },
  {
    ...
    compile_cmd: "/usr/local/swift-5.9.2/bin/swiftc %s Main.swift",
    run_cmd: "./Main"
  },
  # {
  #   id: 84,
